      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            AgentGuard helps you build safer, more efficient, and continuously improving agent systems
          </p>
        </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div className="relative">
              ...
              <p className="mt-3 text-lg text-gray-500">
                AgentGuard works with all major LLM providers and agent frameworks, offering flexible 
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-blue-900 via-blue-800 to-teal-700 p-6 flex flex-col">
                    ...
                    <div className="bg-gray-900/50 backdrop-blur-sm rounded-lg p-4 font-mono text-sm text-teal-100 flex-1 overflow-hidden">
                      <div className="opacity-70">
                        <span className="text-blue-300">import</span> agentguard <span className="text-blue-300">from</span> 'agentguard';<br /><br />
                        
                        <span className="text-blue-300">const</span> monitor = agentguard.<span className="text-teal-300">init</span>&#40;&#123;<br />
                        ...
                        &nbsp;&nbsp;<span className="text-green-300">// Send data to AgentGuard</span><br />
